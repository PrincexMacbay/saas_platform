  ...
  return (
    <>
      <style>{`
        ...
        .sidebar-nav-outer::-webkit-scrollbar {
          width: 6px;
        }

        .sidebar-nav-outer::-webkit-scrollbar-track {
          background: #f1f1f1;
        }

        .sidebar-nav-outer::-webkit-scrollbar-thumb {
          background: #c1c1c1;
          border-radius: 3px;
        }

        .sidebar-nav-outer::-webkit-scrollbar-thumb:hover {
          background: #a8a8a8;
        }
      `}</style>
