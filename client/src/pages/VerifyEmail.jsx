              ...
              <div className="text-center py-8">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mt-8">
                  ...
                  <form onSubmit={handleResendVerification} className="space-y-4">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          type="email"
                          id="resendEmail"
                          className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-gray-500"
                          value={resendEmail}
                    ...
                    <button
                      type="submit"
                      className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 font-semibold text-base transition-all duration-200"
                    >
